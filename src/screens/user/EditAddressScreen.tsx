...
const EditAddressScreen: React.FC = () => {
  ...
  const route = useRoute<RouteProp<{ params: EditAddressParams }, 'params'>>();
  ...
  useEffect(() => {
    if (address) {
      ...
      setCountry(address.country ?? 'UAE');
...
const styles = StyleSheet.create({
  ...
  missingText: { fontSize: FONT_SIZES.md, color: COLORS.textSecondary },
  scroll: { flex: 1 },
